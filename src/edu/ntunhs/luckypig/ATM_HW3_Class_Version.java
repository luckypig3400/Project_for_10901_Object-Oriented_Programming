...
public class ATM_HW3_Class_Version {
    ...
    public int deposit(boolean useScannerToInputAmount, int depositAmount_in) throws InterruptedException{
        int depositAmount = 0;
    ...
    public int withdraw(boolean useScannerToInputAmount, int withdrawAmount_in) throws InterruptedException {
